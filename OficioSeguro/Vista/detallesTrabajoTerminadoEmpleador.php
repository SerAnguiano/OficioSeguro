    ...
    <body class="principal">
        ...
        <?php
            ...
            $consulta= "Select t.IdTrabajo TIdTrabajo, of.DescripcionOficio OFDescripcionOficio, t.Descripcion TDescripcion,
                        ...
                        (cal.Calidad + cal.Trabajo+cal.Pago+cal.Tiempo) calificacion
                        From trabajo t
                        Inner Join oficio of Inner Join empleador emple Inner Join persona p Inner Join empleado emp Inner Join Persona per
                        Inner join evalempleado cal
                        Where of.IdOficio = t.IdOficio AND t.IdEmpleador = emple.IdEmpleador AND p.IdPersona = emp.IdPersona 
        ...
        <div class="table-responsive">
            ...
            <div class="col-sm-4 form-group">
                <a href="../Vista/trabajosTerminadosEmpleador.php"><button type="button" value="" class="btn-lg btn-primary">REGRESAR</button></a>
            </div>
            </form>
        </div>
        </font>
